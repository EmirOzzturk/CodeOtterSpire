...
public class SelectCardView : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    [Header("UI")]
    ...
    {
        if (!_cardData.IsChangeable) return;
    }
    ...
    {
        if (_cardData is null) return;
        
        CharacterSelectSystem.Instance.AddCardToCurrentCardsViaSelect(_cardData);
    }
